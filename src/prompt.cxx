...
//
UnicodeString const forwardSearchBasePrompt("(i-search)`");
UnicodeString const reverseSearchBasePrompt("(reverse-i-search)`");
UnicodeString const endSearchBasePrompt("': ");
